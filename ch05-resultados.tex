...
\begin{floatrow}
\ffigbox{%
  \includegraphics[width=0.9\linewidth]{img/boxplot_irregular_vs_regular.png}%
}{%
...
%Para entender porque o modelo tem mais facilidade com alguns verbos do que outros... coocorrencia etc
